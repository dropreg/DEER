...
data_dir=/opt/data/private/data/glge/glge-released-dataset/easy/squadqg_data/bart_distill_data/processed/data_bin/
save_dir=/opt/data/private/ckpt/deer/glge/squad_distill_pruning_reg30
