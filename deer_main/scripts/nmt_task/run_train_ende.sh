...
data_dir=/opt/data/private/data/deer/dict_trunc/wmt14_ende/kd/data-bin
# save_dir=/opt/data/private/ckpt/deer/wmt14_ende/ctc_src_mask
save_dir=/opt/data/private/ckpt/deer/wmt14_ende/deer_kd_pruning_reg30
...
fairseq-train $data_dir \
    ...
    --lr-scheduler polynomial_decay --total-num-update 100000 --warmup-updates 1000 \
    --max-epoch 50 \
